...
{
    public interface IBidirectionalMovementKeys<TKeyId, TAdditionalKeyEventData> : IKeyboardBasedInput<TKeyId, TAdditionalKeyEventData>
    {
        ...
        BidirectionalMovement MovementDirection { get; }
    }
}
